...
public class WSRegistroBoletoTest {

    @Test
    public void testRegistroEntradaParaJson() {
        final String dadosEntradaJson = new Gson().toJson(new RegistroEntradaBoleto());
    ...
    public void testJsonParaRegistroEntrada() {
        final RegistroRetornoBoleto registroBoleto = new RegistroRetornoBoleto().setCdErro("5");
        final RegistroRetornoBoleto objetoComVirgula = WSRegistroBoleto.converterJsonToRegistroRetorno("{\"cdErro\":\"5\", }");
        final RegistroRetornoBoleto objetoSemVirgula = WSRegistroBoleto.converterJsonToRegistroRetorno("{\"cdErro\":\"5\" }");
